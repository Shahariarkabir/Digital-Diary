...
namespace DIgital_Diary.DesignInterface
{
    public partial class CreateNote : Form
    {
        ...
        private void PostNewEvent_Click(object sender, EventArgs e)
        {
                ...
                string sql = "INSERT INTO New_Event (EventTitle,EventDescription,EventType,EventDate) VALUES('" + EventTitle.Text + "','" + EventDescription.Text + "','" + MarkAsComboBox.Text + "','" + EventDateTimePicker.Text + "')";
